...
{
 string line;
        ifstream f11("weights/W_i_lstm_50.txt");
        if(f11.is_open())
        {
                int c1=0;
        ...
        ifstream f12("weights/W_f_lstm_50.txt");
        if(f12.is_open())
        {
                int c1=0;
        ...
        ifstream f13("weights/W_c_lstm_50.txt");
        if(f13.is_open())
        {
                int c1=0;
        ...
        ifstream f14("weights/W_o_lstm_50.txt");
        if(f14.is_open())
        {
                int c1=0;
	 ...
	 ifstream f21("weights/U_i_lstm_50.txt");
        if(f21.is_open())
        {
                int c1=0;
        ...
        ifstream f22("weights/U_f_lstm_50.txt");
        if(f22.is_open())
        {
                int c1=0;
        ...
        ifstream f23("weights/U_c_lstm_50.txt");
        if(f23.is_open())
        {
                int c1=0;
        ...
        ifstream f24("weights/U_o_lstm_50.txt");
        if(f24.is_open())
        {
                int c1=0;
        ...
        ifstream f31("weights/b_i_lstm_50.txt");
        if(f31.is_open())
        {
                int c1=0;
        ...
        ifstream f32("weights/b_f_lstm_50.txt");
        if(f32.is_open())
        {
                int c1=0;
        ...
        ifstream f33("weights/b_c_lstm_50.txt");
        if(f33.is_open())
        {
                int c1=0;
        ...
        ifstream f34("weights/b_o_lstm_50.txt");
        if(f34.is_open())
        {
                int c1=0;
	...
	ifstream file("weights/dense_lstm_50.txt");
        if(file.is_open())
        {
                int c1=0;
